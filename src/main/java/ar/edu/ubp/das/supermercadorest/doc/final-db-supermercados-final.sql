...
INSERT INTO dbo.sucursales (nro_sucursal,nom_sucursales, calle, nro_calle, telefonos, coord_latitud, coord_longitud, nro_localidad, habilitada) VALUES
(5, 'Sucursal Centro2', 'Calle Principal',123, '351-1234567', -31.4160, -64.1830, 1, 'S');
INSERT INTO dbo.sucursales (nro_sucursal,nom_sucursales, calle, nro_calle, telefonos, coord_latitud, coord_longitud, nro_localidad, habilitada) VALUES
(6, 'Sucursal Pacifico', 'Calle Principal',123, '351-1234567', -31.4160, -64.1830, 5, 'S');
...
(1, 'Lácteos', 1, 'S'),
(2, 'Gaseosas', 2, 'S'),
(3, 'Papel Higiénico', 3, 'S'),
(4, 'Productos de limpieza', 4, 'S'),
(5, 'Jugos', 2, 'S');
INSERT INTO dbo.categorias_productos (nro_categoria, nom_categoria, nro_rubro, vigente) VALUES
(6, 'Productos belleza', 3, 'S'),
(7, 'Galletas', 1, 'S');
...
delete from dbo.productos where cod_barra = '1234567890126';
...
ALTER TABLE dbo.productos_sucursales 
ADD cod_barra_prod_sustituto VARCHAR(50) NULL;
...
update dbo.productos_sucursales set precio = 1250.00 where cod_barra = '1234567890127' and nro_sucursal = 1; 
update dbo.productos_sucursales set precio = 1000.00 where cod_barra = '1234567890128' and nro_sucursal = 1; 

delete dbo.productos_sucursales where cod_barra = '1234567890140' ;
...
INSERT INTO dbo.productos_sucursales (nro_sucursal, cod_barra, precio, vigente) VALUES
(5, '1234567890126', 2500.00, 'S'), -- Detergente Líquido Marca C
(5, '1234567890127', 1300.00, 'S'), -- Jabón de Manos Marca C
(5, '1234567890128', 1110.00, 'S'), -- Jugo en Polvo Marca D
(5, '1234567890129', 2300.00, 'S'), -- Jugo en Botella Marca E
(5, '1234567890130', 1350.00, 'S'); -- Leche Descremada 1L

INSERT INTO dbo.productos_sucursales (nro_sucursal, cod_barra, precio, vigente) VALUES
(6, '1234567890126', 2500.00, 'S'), -- Detergente Líquido Marca C
(6, '1234567890127', 1300.00, 'S'), -- Jabón de Manos Marca C
(6, '1234567890128', 1110.00, 'S'), -- Jugo en Polvo Marca D
(6, '1234567890129', 2300.00, 'S'), -- Jugo en Botella Marca E
(6, '1234567890130', 1350.00, 'S'); -- Leche Descremada 1L


-- productos sustitutos
-- Actualización de productos con productos sustitutos
UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890131' 
WHERE cod_barra = '1234567890126'; -- Detergente Líquido Marca C -> Detergente Líquido Marca B

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890132' 
WHERE cod_barra = '1234567890127'; -- Jabón de Manos Marca C -> Jabón de Manos Marca C'

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890139' 
WHERE cod_barra = '1234567890135'; -- Yogur Natural 1L -> Yogur Sabor Durazno 1L

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890138' 
WHERE cod_barra = '1234567890130'; -- Leche Descremada 1L -> Leche Descremada 1L Marca B

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890128' 
WHERE cod_barra = '1234567890140'; -- Jugo en Polvo Marca D -> Jugo en Polvo Marca D (otra marca)

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890134' 
WHERE cod_barra = '1234567890129'; -- Jugo en Botella Marca E -> Jugo en Botella Marca E (variante)

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890136' 
WHERE cod_barra = '1234567890133'; -- Coca Cola Zero 2L -> Gaseosa Fanta 2L

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890126' 
WHERE cod_barra = '1234567890137'; -- Detergente Líquido Marca C -> Detergente Líquido Marca C

UPDATE dbo.productos_sucursales 
SET cod_barra_prod_sustituto = '1234567890133' 
WHERE cod_barra = '1234567890136'; -- Gaseosa Fanta 2L -> Coca Cola Zero 2L
